...
//      key: Key(_phone),
    ...
    return ListView(
      ...
      children: <Widget>[
        ...
        Text(isRegistered ? Language.of(context).handicap + ": " + _handicap.toString().substring(0, _handicap.toString().length > 4 ? 5 : 4) : '', style: TextStyle(fontWeight: FontWeight.bold)),
        SizedBox(
          height: 10.0,
        ),
        loginButton
