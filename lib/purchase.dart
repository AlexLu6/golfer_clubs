    ...
    builder: (context, snapshot) {
      if (!snapshot.hasData)
        ...
        return Text(
          ...
          '${_items[0].title!.substring(0, 20)}  Price: ${_items[0].price}\n' +
          '${_items[1].title!.substring(0, 20)}  Price: ${_items[1].price}\n' +
          '${_items[2].title!.substring(0, 20)}  Price: ${_items[2].price}\n' +
