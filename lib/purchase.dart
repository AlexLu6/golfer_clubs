    ...
    builder: (context, snapshot) {
      if (!snapshot.hasData)
        ...
        return Text(
          ...
          'Prodcut ID: ${_items[0].description}  Price: ${_items[0].price}\n' +
          'Prodcut ID: ${_items[1].description}  Price: ${_items[1].price}\n' +
          'Prodcut ID: ${_items[2].description}  Price: ${_items[2].price}\n'
        );
      }
    });
}
